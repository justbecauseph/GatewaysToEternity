...
public class NormalGateClient {
    ...
    public static void appendPearlTooltip(NormalGateway gate, TooltipContext ctx, Consumer<Component> tooltips, TooltipFlag flag) {
        ...
        if (Minecraft.getInstance().hasShiftDown()) {
            ...
            // tooltips.accept(Component.nullToEmpty(null));
